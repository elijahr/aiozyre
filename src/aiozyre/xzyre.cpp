...
static PyMethodDef xzyre_functions[] = {
    ...
    {(char *) "zpoller_add", (PyCFunction) _wrap_xzyre_zpoller_add, METH_VARARGS|METH_KEYWORDS, "zpoller_add(self, reader)\n\ntype: self: zpoller_t *\ntype: reader: zsock_t *" },
    {(char *) "zpoller_wait", (PyCFunction) _wrap_xzyre_zpoller_wait, METH_VARARGS|METH_KEYWORDS, NULL },
    {(char *) "zpoller_expired", (PyCFunction) _wrap_xzyre_zpoller_expired, METH_VARARGS|METH_KEYWORDS, "zpoller_expired(self)\n\ntype: self: zpoller_t *" },
    {(char *) "zmsg_new", (PyCFunction) _wrap_xzyre_zmsg_new, METH_NOARGS, "zmsg_new()\n\n" },
    {(char *) "zmsg_popstr", (PyCFunction) _wrap_xzyre_zmsg_popstr, METH_VARARGS|METH_KEYWORDS, "zmsg_popstr(self)\n\ntype: self: zmsg_t *" },
    {(char *) "zmsg_popbytes", (PyCFunction) _wrap_xzyre_zmsg_popbytes, METH_VARARGS|METH_KEYWORDS, "zmsg_popbytes(self)\n\ntype: self: zmsg_t *" },
    {(char *) "zmsg_pushstr", (PyCFunction) _wrap_xzyre_zmsg_pushstr, METH_VARARGS|METH_KEYWORDS, "zmsg_pushstr(self, string)\n\ntype: self: zmsg_t *\ntype: string: char const *" },
    {(char *) "zmsg_pushbytes", (PyCFunction) _wrap_xzyre_zmsg_pushbytes, METH_VARARGS|METH_KEYWORDS, "zmsg_pushbytes(self, string)\n\ntype: self: zmsg_t *\ntype: string: PYBYTE const *" },
    {(char *) "zyre_new", (PyCFunction) _wrap_xzyre_zyre_new, METH_VARARGS|METH_KEYWORDS, "zyre_new(name)\n\ntype: name: char *" },
    {(char *) "zyre_uuid", (PyCFunction) _wrap_xzyre_zyre_uuid, METH_VARARGS|METH_KEYWORDS, "zyre_uuid(self)\n\ntype: self: zyre_t *" },
    {(char *) "zyre_name", (PyCFunction) _wrap_xzyre_zyre_name, METH_VARARGS|METH_KEYWORDS, "zyre_name(self)\n\ntype: self: zyre_t *" },
    {(char *) "zyre_set_header", (PyCFunction) _wrap_xzyre_zyre_set_header, METH_VARARGS|METH_KEYWORDS, "zyre_set_header(self, name, value)\n\ntype: self: zyre_t *\ntype: name: char *\ntype: value: char *" },
    {(char *) "zyre_set_verbose", (PyCFunction) _wrap_xzyre_zyre_set_verbose, METH_VARARGS|METH_KEYWORDS, "zyre_set_verbose(self)\n\ntype: self: zyre_t *" },
    {(char *) "zyre_set_evasive_timeout", (PyCFunction) _wrap_xzyre_zyre_set_evasive_timeout, METH_VARARGS|METH_KEYWORDS, "zyre_set_evasive_timeout(self, interval)\n\ntype: self: zyre_t *\ntype: interval: int" },
    {(char *) "zyre_set_expired_timeout", (PyCFunction) _wrap_xzyre_zyre_set_expired_timeout, METH_VARARGS|METH_KEYWORDS, "zyre_set_expired_timeout(self, interval)\n\ntype: self: zyre_t *\ntype: interval: int" },
    {(char *) "zyre_set_interval", (PyCFunction) _wrap_xzyre_zyre_set_interval, METH_VARARGS|METH_KEYWORDS, "zyre_set_interval(self, interval)\n\ntype: self: zyre_t *\ntype: interval: int" },
    {(char *) "zyre_set_endpoint", (PyCFunction) _wrap_xzyre_zyre_set_endpoint, METH_VARARGS|METH_KEYWORDS, "zyre_set_endpoint(self, value)\n\ntype: self: zyre_t *\ntype: value: char *" },
    {(char *) "zyre_gossip_bind", (PyCFunction) _wrap_xzyre_zyre_gossip_bind, METH_VARARGS|METH_KEYWORDS, "zyre_gossip_bind(self, value)\n\ntype: self: zyre_t *\ntype: value: char *" },
    {(char *) "zyre_gossip_connect", (PyCFunction) _wrap_xzyre_zyre_gossip_connect, METH_VARARGS|METH_KEYWORDS, "zyre_gossip_connect(self, value)\n\ntype: self: zyre_t *\ntype: value: char *" },
    {(char *) "zyre_start", (PyCFunction) _wrap_xzyre_zyre_start, METH_VARARGS|METH_KEYWORDS, "zyre_start(self)\n\ntype: self: zyre_t *" },
    {(char *) "zyre_stop", (PyCFunction) _wrap_xzyre_zyre_stop, METH_VARARGS|METH_KEYWORDS, "zyre_stop(self)\n\ntype: self: zyre_t *" },
    {(char *) "zyre_join", (PyCFunction) _wrap_xzyre_zyre_join, METH_VARARGS|METH_KEYWORDS, "zyre_join(self, group)\n\ntype: self: zyre_t *\ntype: group: char *" },
    {(char *) "zyre_leave", (PyCFunction) _wrap_xzyre_zyre_leave, METH_VARARGS|METH_KEYWORDS, "zyre_leave(self, group)\n\ntype: self: zyre_t *\ntype: group: char *" },
    {(char *) "zyre_recv", (PyCFunction) _wrap_xzyre_zyre_recv, METH_VARARGS|METH_KEYWORDS, "zyre_recv(self)\n\ntype: self: zyre_t *" },
    {(char *) "zyre_whisper", (PyCFunction) _wrap_xzyre_zyre_whisper, METH_VARARGS|METH_KEYWORDS, "zyre_whisper(self, peer, msg)\n\ntype: self: zyre_t *\ntype: peer: char *\ntype: msg: zmsg_t **" },
    {(char *) "zyre_shout", (PyCFunction) _wrap_xzyre_zyre_shout, METH_VARARGS|METH_KEYWORDS, "zyre_shout(self, group, msg)\n\ntype: self: zyre_t *\ntype: group: char *\ntype: msg: zmsg_t **" },
    {(char *) "zyre_whispers", (PyCFunction) _wrap_xzyre_zyre_whispers, METH_VARARGS|METH_KEYWORDS, "zyre_whispers(self, peer, msg)\n\ntype: self: zyre_t *\ntype: peer: char *\ntype: msg: char *" },
    {(char *) "zyre_shouts", (PyCFunction) _wrap_xzyre_zyre_shouts, METH_VARARGS|METH_KEYWORDS, "zyre_shouts(self, group, msg)\n\ntype: self: zyre_t *\ntype: group: char *\ntype: msg: char *" },
    {(char *) "zyre_peers", (PyCFunction) _wrap_xzyre_zyre_peers, METH_VARARGS|METH_KEYWORDS, NULL },
    {(char *) "zyre_own_groups", (PyCFunction) _wrap_xzyre_zyre_own_groups, METH_VARARGS|METH_KEYWORDS, NULL },
    {(char *) "zyre_peer_groups", (PyCFunction) _wrap_xzyre_zyre_peer_groups, METH_VARARGS|METH_KEYWORDS, NULL },
    {(char *) "zyre_peers_by_group", (PyCFunction) _wrap_xzyre_zyre_peers_by_group, METH_VARARGS|METH_KEYWORDS, NULL },
    {(char *) "zyre_peer_address", (PyCFunction) _wrap_xzyre_zyre_peer_address, METH_VARARGS|METH_KEYWORDS, "zyre_peer_address(self, peer)\n\ntype: self: zyre_t *\ntype: peer: char *" },
    {(char *) "zyre_peer_header_value", (PyCFunction) _wrap_xzyre_zyre_peer_header_value, METH_VARARGS|METH_KEYWORDS, "zyre_peer_header_value(self, peer, name)\n\ntype: self: zyre_t *\ntype: peer: char *\ntype: name: char *" },
    {(char *) "zyre_socket", (PyCFunction) _wrap_xzyre_zyre_socket, METH_VARARGS|METH_KEYWORDS, "zyre_socket(self)\n\ntype: self: zyre_t *" },
